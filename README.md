...
Plusieurs branch à votre disposition:
 ...
 - middleware (gestion des routes (en cours))
 ...
 - populate-advanced (Fonction MongoDB de relation entre Model (en attente))
 - reqFlash (gerer req.flash, plusieurs manières proposer (OK))
 - secondLayout (gerer un deuxieme layout avec Handlebars(OK))
 - session (Authentification + session (express-session) (OK) (a finir les commentaire))
 - validator (gerer validator.js, base (en cours))
 - vanta (intégrer vanta.js (en cours))

# Pré-requis
  - NodeJS v10.0.0 (attention la v12 va bientot etre utiliser sur tout les projets)
